...
use crate::model::collections::{SymbolContext, SymbolDb};
...
pub fn inject_primitives(db: &mut SymbolDb, ctx: &mut SymbolContext) {
    [
...
pub fn inject_misc_native_types(db: &mut SymbolDb, ctx: &SymbolContext) {
...
pub fn inject_globals(db: &mut SymbolDb, ctx: &mut SymbolContext) {
    [
        ("theGame", "CR4Game"),
...
pub fn inject_array_type(db: &mut SymbolDb, ctx: &mut SymbolContext, data_type_id: Uuid, data_type_name: &str) -> Uuid {
