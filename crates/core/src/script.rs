...
use crate::{ast::{DeclarationTraversal, DeclarationVisitor, RootNode}, script_document::ScriptDocument};
...
impl Script {
    ...
    pub fn visit_nodes<V: DeclarationVisitor>(&self, visitor: &mut V) {
