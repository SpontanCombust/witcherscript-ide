...
use super::{SyntaxTraversal, SyntaxVisitor};
...
impl SyntaxTraversal for EnumDeclarationNode<'_> {
...
impl SyntaxTraversal for EnumBlockNode<'_> {
    fn accept<V: SyntaxVisitor>(&self, visitor: &mut V) {
...
impl SyntaxTraversal for EnumVariantDeclarationNode<'_> {
    fn accept<V: SyntaxVisitor>(&self, visitor: &mut V) {
