...
pub trait SyntaxVisitor {
    ...
    fn visit_func_call_expr(&mut self, n: &FunctionCallExpressionNode) -> FunctionCallExpressionTraversalPolicy { Default::default() }
    ...
    fn visit_array_expr(&mut self, n: &ArrayExpressionNode) -> ArrayExpressionTraversalPolicy { Default::default() }
    ...
    fn visit_member_field_expr(&mut self, n: &MemberFieldExpressionNode) -> MemberFieldExpressionTraversalPolicy { Default::default() }
    ...
    fn visit_new_expr(&mut self, n: &NewExpressionNode) -> NewExpressionTraversalPolicy { Default::default() }
    ...
    fn visit_type_cast_expr(&mut self, n: &TypeCastExpressionNode) -> TypeCastExpressionTraversalPolicy { Default::default() }
    ...
    fn visit_unary_op_expr(&mut self, n: &UnaryOperationExpressionNode) -> UnaryOperationExpressionTraversalPolicy { Default::default() }
    ...
    fn visit_binary_op_expr(&mut self, n: &BinaryOperationExpressionNode) -> BinaryOperationExpressionTraversalPolicy { Default::default() }
    ...
    fn visit_assign_op_expr(&mut self, n: &AssignmentOperationExpressionNode) -> AssignmentOperationExpressionTraversalPolicy { Default::default() }
    ...
    /// All true by default.
    fn visit_ternary_cond_expr(&mut self, n: &TernaryConditionalExpressionNode) -> TernaryConditionalExpressionTraversalPolicy { Default::default() }
