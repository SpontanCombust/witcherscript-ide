...
pub trait SyntaxNodeVisitor {
    const TRAVERSAL_POLICY_DEFAULT: bool;


    /// Called when visiting a parenthesized expression node.
    fn visit_nested_expr(&mut self, n: &NestedExpressionNode, ctx: ExpressionTraversalContext) -> NestedExpressionTraversalPolicy { DefaultTo::default_to(Self::TRAVERSAL_POLICY_DEFAULT) }
    ...
    fn visit_func_call_expr(&mut self, n: &FunctionCallExpressionNode, ctx: ExpressionTraversalContext) -> FunctionCallExpressionTraversalPolicy { DefaultTo::default_to(Self::TRAVERSAL_POLICY_DEFAULT) }
    ...
    fn visit_func_call_arg(&mut self, n: &FunctionCallArgument) -> FunctionCallArgumentTraversalPolicy { DefaultTo::default_to(Self::TRAVERSAL_POLICY_DEFAULT) }
    ...
    fn visit_array_expr(&mut self, n: &ArrayExpressionNode, ctx: ExpressionTraversalContext) -> ArrayExpressionTraversalPolicy { DefaultTo::default_to(Self::TRAVERSAL_POLICY_DEFAULT) }
    ...
    fn visit_member_field_expr(&mut self, n: &MemberFieldExpressionNode, ctx: ExpressionTraversalContext) -> MemberFieldExpressionTraversalPolicy { DefaultTo::default_to(Self::TRAVERSAL_POLICY_DEFAULT) }
    ...
    fn visit_new_expr(&mut self, n: &NewExpressionNode, ctx: ExpressionTraversalContext) -> NewExpressionTraversalPolicy { DefaultTo::default_to(Self::TRAVERSAL_POLICY_DEFAULT) }
    ...
    fn visit_type_cast_expr(&mut self, n: &TypeCastExpressionNode, ctx: ExpressionTraversalContext) -> TypeCastExpressionTraversalPolicy { DefaultTo::default_to(Self::TRAVERSAL_POLICY_DEFAULT) }
    ...
    fn visit_unary_op_expr(&mut self, n: &UnaryOperationExpressionNode, ctx: ExpressionTraversalContext) -> UnaryOperationExpressionTraversalPolicy { DefaultTo::default_to(Self::TRAVERSAL_POLICY_DEFAULT) }
    ...
    fn visit_binary_op_expr(&mut self, n: &BinaryOperationExpressionNode, ctx: ExpressionTraversalContext) -> BinaryOperationExpressionTraversalPolicy { DefaultTo::default_to(Self::TRAVERSAL_POLICY_DEFAULT) }
    ...
    fn visit_assign_op_expr(&mut self, n: &AssignmentOperationExpressionNode, ctx: ExpressionTraversalContext) -> AssignmentOperationExpressionTraversalPolicy { DefaultTo::default_to(Self::TRAVERSAL_POLICY_DEFAULT) }
    ...
    fn visit_ternary_cond_expr(&mut self, n: &TernaryConditionalExpressionNode, ctx: ExpressionTraversalContext) -> TernaryConditionalExpressionTraversalPolicy { DefaultTo::default_to(Self::TRAVERSAL_POLICY_DEFAULT) }
    ...
    fn visit_root(&mut self, n: &RootNode) -> RootTraversalPolicy { DefaultTo::default_to(Self::TRAVERSAL_POLICY_DEFAULT) }

    /// Called when visiting a class declaration.
    fn visit_class_decl(&mut self, n: &ClassDeclarationNode) -> ClassDeclarationTraversalPolicy { DefaultTo::default_to(Self::TRAVERSAL_POLICY_DEFAULT) }
    ...
    fn visit_state_decl(&mut self, n: &StateDeclarationNode) -> StateDeclarationTraversalPolicy { DefaultTo::default_to(Self::TRAVERSAL_POLICY_DEFAULT) }
    ...
    fn visit_struct_decl(&mut self, n: &StructDeclarationNode) -> StructDeclarationTraversalPolicy { DefaultTo::default_to(Self::TRAVERSAL_POLICY_DEFAULT) }
    ...
    fn visit_enum_decl(&mut self, n: &EnumDeclarationNode) -> EnumDeclarationTraversalPolicy { DefaultTo::default_to(Self::TRAVERSAL_POLICY_DEFAULT) }
    ...
    fn visit_member_default_val(&mut self, n: &MemberDefaultValueNode, ctx: PropertyTraversalContext) -> MemberDefaultValueTraversalPolicy { DefaultTo::default_to(Self::TRAVERSAL_POLICY_DEFAULT) }
    ...
    fn visit_member_defaults_block(&mut self, n: &MemberDefaultsBlockNode, ctx: PropertyTraversalContext) -> MemberDefaultsBlockTraversalPolicy { DefaultTo::default_to(Self::TRAVERSAL_POLICY_DEFAULT) }
    ...
    fn visit_member_defaults_block_assignment(&mut self, n: &MemberDefaultsBlockAssignmentNode) -> MemberDefaultValueTraversalPolicy { DefaultTo::default_to(Self::TRAVERSAL_POLICY_DEFAULT) }
    ...
    fn visit_global_func_decl(&mut self, n: &GlobalFunctionDeclarationNode) -> GlobalFunctionDeclarationTraversalPolicy { DefaultTo::default_to(Self::TRAVERSAL_POLICY_DEFAULT) }
    ...
    fn visit_member_func_decl(&mut self, n: &MemberFunctionDeclarationNode, ctx: PropertyTraversalContext) -> MemberFunctionDeclarationTraversalPolicy { DefaultTo::default_to(Self::TRAVERSAL_POLICY_DEFAULT) }
    ...
    fn visit_event_decl(&mut self, n: &EventDeclarationNode, ctx: PropertyTraversalContext) -> EventDeclarationTraversalPolicy { DefaultTo::default_to(Self::TRAVERSAL_POLICY_DEFAULT) }
    /// Called after visiting member function declaration and possibly also children nodes specified in traversal policy.
    ...
    fn visit_local_var_decl_stmt(&mut self, n: &VarDeclarationNode, ctx: StatementTraversalContext) -> VarDeclarationTraversalPolicy { DefaultTo::default_to(Self::TRAVERSAL_POLICY_DEFAULT) }
    ...
    fn visit_expr_stmt(&mut self, n: &ExpressionStatementNode, ctx: StatementTraversalContext) -> ExpressionStatementTraversalPolicy { DefaultTo::default_to(Self::TRAVERSAL_POLICY_DEFAULT) }
    ...
    fn visit_for_stmt(&mut self, n: &ForLoopNode, ctx: StatementTraversalContext) -> ForLoopTraversalPolicy { DefaultTo::default_to(Self::TRAVERSAL_POLICY_DEFAULT) }
    ...
    fn visit_while_stmt(&mut self, n: &WhileLoopNode, ctx: StatementTraversalContext) -> WhileLoopTraversalPolicy { DefaultTo::default_to(Self::TRAVERSAL_POLICY_DEFAULT) }
    ...
    fn visit_do_while_stmt(&mut self, n: &DoWhileLoopNode, ctx: StatementTraversalContext) -> DoWhileLoopTraversalPolicy { DefaultTo::default_to(Self::TRAVERSAL_POLICY_DEFAULT) }
    ...
    fn visit_if_stmt(&mut self, n: &IfConditionalNode, ctx: StatementTraversalContext) -> IfConditionalTraversalPolicy { DefaultTo::default_to(Self::TRAVERSAL_POLICY_DEFAULT) }
    ...
    fn visit_switch_stmt(&mut self, n: &SwitchConditionalNode, ctx: StatementTraversalContext) -> SwitchConditionalTraversalPolicy { DefaultTo::default_to(Self::TRAVERSAL_POLICY_DEFAULT) }
    ...
    fn visit_switch_stmt_case(&mut self, n: &SwitchConditionalCaseLabelNode) -> SwitchConditionalCaseLabelTraversalPolicy { DefaultTo::default_to(Self::TRAVERSAL_POLICY_DEFAULT) }
    ...
    fn visit_return_stmt(&mut self, n: &ReturnStatementNode, ctx: StatementTraversalContext) -> ReturnStatementTraversalPolicy { DefaultTo::default_to(Self::TRAVERSAL_POLICY_DEFAULT) }
    ...
    fn visit_delete_stmt(&mut self, n: &DeleteStatementNode, ctx: StatementTraversalContext) -> DeleteStatementTraversalPolicy { DefaultTo::default_to(Self::TRAVERSAL_POLICY_DEFAULT) }
    ...
    fn visit_compound_stmt(&mut self, n: &CompoundStatementNode, ctx: StatementTraversalContext) -> CompoundStatementTraversalPolicy { DefaultTo::default_to(Self::TRAVERSAL_POLICY_DEFAULT) }
