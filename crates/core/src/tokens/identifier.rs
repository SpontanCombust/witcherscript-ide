...
use crate::{ast::{SyntaxTraversal, SyntaxVisitor}, script_document::ScriptDocument, AnyNode, DebugRange, NamedSyntaxNode, SyntaxNode};
...
impl SyntaxTraversal for IdentifierNode<'_> {
